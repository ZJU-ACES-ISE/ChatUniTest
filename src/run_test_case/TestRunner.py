...
class TestRunner():
    ...
    def __init__(self, test_path, target_path, tool="cobertura"):
        ...
        :param test_path: test cases directory path, e.g., /data/share/TestGPT_ASE/result/scope_test%20230414210243%d3_1/
        ...
        self.build_dir = self.process_single_repo(self.target_path, self.build_dir_name)
        ...
        self.COBERTURA_DIR = "/root/TestGPT_ASE/src/run_test_case/dependencies/cobertura-2.1.1"
        self.JUNIT_JAR = "/root/TestGPT_ASE/src/run_test_case/dependencies/lib/junit-platform-console-standalone-1.9.2.jar"
        self.MOCKITO_JAR = "/root/TestGPT_ASE/src/run_test_case/dependencies/lib/mockito-core-3.12.4.jar:\
        ...
        self.LOG4J_JAR = "/root/TestGPT_ASE/src/run_test_case/dependencies/lib/slf4j-api-1.7.5.jar:\
        ...
        self.JACOCO_AGENT = "/root/TestGPT_ASE/src/run_test_case/dependencies/jacoco/jacocoagent.jar"
        self.JACOCO_CLI = "/root/TestGPT_ASE/src/run_test_case/dependencies/jacoco/jacococli.jar"

    def start_single_test(self, single_test_src):
        """
        ...
        if not os.path.exists(compiled_test_dir):
            os.mkdir(compiled_test_dir)
        try:
    ...
    def start_all_test(self):
        ...
        self.copy_tests(self.test_path, self.target_path, tests_dir)
    ...
    def javac_cmd(self, compiled_test_dir, test_file):
        classpath = f"{self.dependencies}:{self.JUNIT_JAR}:{self.MOCKITO_JAR}:{self.LOG4J_JAR}:{self.build_dir}:."
        classpath_file = os.path.join(self.compiled_test_dir, 'classpath.txt')
    ...
    def java_cmd(self, compiled_test_dir, test_file):
        ...
        classpath = f"{self.COBERTURA_DIR}/cobertura-2.1.1.jar:{compiled_test_dir}/instrumented:{compiled_test_dir}:" \
                    f"{self.dependencies}:{self.JUNIT_JAR}:{self.MOCKITO_JAR}:{self.LOG4J_JAR}:{self.build_dir}:."
