...
def parse_data(dir_path, target_class, target_method=""):
    """
    ...
    class_id = 0
    method_id = 0
    class_datapath = '../dataset/class'
    method_datapath = '../dataset/method'
    for root, dirs, files in os.walk(dir_path):
        for filename in files:
            if filename.endswith('.json') and filename.starswith(target_class):
